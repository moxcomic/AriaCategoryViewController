...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AriaCategoryViewController/AriaCategoryViewController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AriaSwiftyChain/AriaSwiftyChain.framework"
